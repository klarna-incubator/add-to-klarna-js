...
import { ALG, ENC, encryptJwe } from "../src/encryptJwe.js";
...
describe("encryptJwe", () => {
  ...
  it("wraps a JWK import failure in ENCRYPTION_FAILED", async () => {
    // An RSA JWK cannot be imported under the pinned ECDH-ES+A256KW alg.
    const brokenJwk = { kid: "k", kty: "RSA", n: "!!!", e: "AQAB" };
    await expect(
